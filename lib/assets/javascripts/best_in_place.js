    ...
    "multiselect" : {
      activateForm : function() {
        ...
        if(typeof this.useChosen == 'object') {
            ...
            $chosenInput.bind('blur', {editor: this}, BestInPlaceEditor.forms.multiselect.blurHandler);
            $chosenInput.focus();
        }
        else {
            select_elt.bind('blur', {editor: this}, BestInPlaceEditor.forms.multiselect.blurHandler);
