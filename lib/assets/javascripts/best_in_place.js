    ...
    "multiselect" : {
      activateForm : function() {
        ...
        jQuery.each(this.values, function (index, value) {
          ...
          // console.log("currentCollectionValue = ", currentCollectionValue);
          // console.log("currentCollectionValue.indexOf(value[0]) = ", currentCollectionValue.indexOf(value[0]));
        ...
        this.setHtmlAttributes();
        if(typeof this.useChosen == 'object') {
            chosen_elt = this.element.find("div.chosen-container");
            _this = this;
            $(document).bind('click', {editor: this}, function(e) {
                clicked = $(e.target)
                if(clicked.is(chosen_elt) || clicked.closest(chosen_elt).length || clicked.is(_this.element)) {
                    return;
                }
                else {
